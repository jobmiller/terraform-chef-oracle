...
# Define Source
software_repo = "https://objectstorage.us-ashburn-1.oraclecloud.com/n/oci_core_eca_jmiller/b/Oracle_Binaries/o"
...
execute "Apply Patch #{patch} to Oracle Home" do
  command "#{node['oracle']['oracle_home_12c']}/OPatch/opatch apply -silent"
  user node['oracle']['user']
  group node['oracle']['group']
